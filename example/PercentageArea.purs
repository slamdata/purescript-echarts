  ...
  series = Just $ Just <$> [
    LineSeries {
      ...
      lineSeries: lineSeriesDefault {
        ...
        smooth = Just true,
        "data" = Just $ (cons
          (Dat $ mkAnnotationItem (Simple (fromMaybe zero $ head ageUnder30)))
    ...
    LineSeries {
      ...
      lineSeries: lineSeriesDefault {
        ...
        smooth = Just true,
        "data" = Just $ (cons
          (Dat $ mkAnnotationItem (Simple (fromMaybe zero $ head age30To39)))
    ...
    LineSeries {
      ...
      lineSeries: lineSeriesDefault {
        ...
        smooth = Just true,
        "data" = Just $ (cons
          (Dat $ mkAnnotationItem (Simple (fromMaybe zero $ head age40To49)))
    ...
    LineSeries {
      ...
      lineSeries: lineSeriesDefault {
        ...
        smooth = Just true,
        "data" = Just $ (cons
          (Dat $ mkAnnotationItem (Simple (fromMaybe zero $ head age50To59)))
...
ageUnder30 =
  [ 6.04, 5.69, 5.36, 4.95, 6.23, 7.2, 6.94, 7.11, 7.33, 7.65, 8.02, 8.36, 8.29, 9.35, 8.9
  , 8.68, 10.14, 8.73, 8.44, 8.38, 10.03, 9.13, 9.15, 8.56, 7.02, 6.87, 6.21, 6.26, 5.89, 5.97
  , 6.34, 7.68, 7.62, 6.91 ]

age30To39 = 
  [ 7.25, 7.22, 6.92, 6.88, 7.52, 8.2, 8.37, 8.87, 9.16, 9.17, 9.7, 10.2, 10.56, 11.85, 12.9, 13.18
  , 15.37, 15.71, 15.3, 15.58, 16.69, 17.37, 18.19, 18.38, 17.82, 16.47, 15.72, 15.36, 14.56, 13.75
  , 13.28, 13.56, 12.49, 12.23 ]

age40To49 =
  [ 16.72, 16.31, 15.92, 15.47, 15.55, 15.85, 15.6, 15.5, 15.58, 14.75, 14.8, 15.03, 15.2, 15.57, 16.34
  , 17.48, 18.63, 18.39, 19.07, 20.63, 20.37, 21.86, 22.77, 22.75, 23.68, 23.45, 24.53, 25.19, 24.93
  , 25.53, 24.52, 23.83, 24.08, 23.98 ]

age50To59 = 
  [ 39.89, 39.99, 40.69, 41.91, 40.81, 40.16, 39.89, 39.92, 39.99, 40.31, 40.07, 39.62, 39.28, 37.39
  , 36.47, 38.2, 35.78, 36.27, 37.24, 34.88, 34.93, 33.69, 32.19, 34.53, 35.86, 36.77, 37.81, 37.83
  , 39.7, 39.43, 39.46, 39.36, 40.13, 40.62 ]

age_60_64 = 
  [ 30.09, 30.8, 31.12, 30.79, 29.89, 28.58, 29.21, 28.6, 27.94, 28.12, 27.41, 26.8, 26.67, 25.83, 25.4
  , 22.47, 20.08, 20.9, 19.95, 20.52, 17.97, 17.96, 17.7, 15.77, 15.62, 16.45, 15.74, 15.36, 14.92, 15.32
