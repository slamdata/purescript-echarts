...
instance oneManyJsonEncode :: (EncodeJson a) => EncodeJson (OneMany a) where 
  encodeJson oneMany = case oneMany of
    One a -> encodeJson a
    Many as -> encodeJson as
...
data Radius = R Number | Rs {inner :: Number, outer :: Number}
